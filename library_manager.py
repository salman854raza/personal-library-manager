...
# import plotly.graph__objects as go
...
def create_visualization(stats):
    ...
    if stats['decades']:
        ...
        # load library 
load_library
st.slider.markdown("<h1 style='text-align: center;'> Navigation</h1>", unsafe_allow_html=True)
            ...
            with cols[i % 2]:
                st.markdown(f"""<div class = 'book-card'>
                            ...
                            <p><span class='{"read-badge" if book["read_status"] else "unread-badge"}'>{
                                "Read" if book["read_status"] else "unreead"
                            }</span></p>
                            </div>
...
st.markdown("---")
st.markdown("Copyright @ 2025 Salman Raza Personal Library Manager ", unsafe_allow_html=True)
